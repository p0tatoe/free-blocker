...
open class DnsProxy: Disposable, AutoCloseable, DnsProxyInterface
{
    ...
    override fun `updateBlocklist`(`domains`: List<kotlin.String>)
        = 
    callWithHandle {
    uniffiRustCall() { _status ->
 ...
 * @suppress
 */
public object FfiConverterTypeDnsProxy: FfiConverter<DnsProxy, Long> {
    override fun lower(value: DnsProxy): Long {
        return value.uniffiCloneHandle()
    }

    override fun lift(value: Long): DnsProxy {
        return DnsProxy(UniffiWithHandle, value)
    }

    override fun read(buf: ByteBuffer): DnsProxy {
        return lift(buf.getLong())
    }

    override fun allocationSize(value: DnsProxy) = 8UL
